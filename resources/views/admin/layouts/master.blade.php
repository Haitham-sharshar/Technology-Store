                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <p>{{Auth::guard('admin')->check()? Auth::guard('admin')->user()->name: 'Account'}}</p>
                                <b class="caret"></b>
                            </a>
...
{{--with laravel collective style --}}

{{--
{{Html::style('assets/js/jquery-1.10.2.js')}}
{{Html::style('assets/js/bootstrap.min.js')}}
{{Html::style('assets/js/script.js')}}
