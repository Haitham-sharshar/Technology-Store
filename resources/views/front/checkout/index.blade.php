        ...
        @endif
            ...
            <form action="{{route('checkout')}}" method="post" id="payment-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name_on_card" name="name_card" placeholder="Name on card">
                </div>
...
@section('script')
    <script>
        ...
        var stripe = Stripe('pk_test_51HcquqBxwKRwW50ecnojcx2KyjBVc8nqBOXHLHhZDe8z1rVtPcd0Cf00bglZWjw6JQBfJI4qnNh44jN7MbzkjKR50034apz1C7');
